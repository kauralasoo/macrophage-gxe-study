...
cat motif_batches.txt | tail -n 251 | python ~/software/utils/submitJobs.py --MEM 4000 --jobname calculate_motif_disruptions --command "/software/R-3.3.0/bin/Rscript macrophage-gxe-study/ATAC/finemapping/caQTL_motif_disruptions.R"
