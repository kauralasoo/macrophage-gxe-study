...
design = housekeeping::constructDesignMatrix_SL1344(sample_names)
...
write.table(unique(gt_map$genotype_id), "macrophage-gxe-study/data/sample_lists/SL1344/SL1344_gt_list.txt", sep = "\t", 
            quote = FALSE, row.names = FALSE, col.names = FALSE)