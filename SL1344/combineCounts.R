...
basic_data = loadCounts("STAR/SL1344_counts/", sample_names, sub_dir = FALSE, counts_suffix = ".gencode_basic.counts.txt")
...
complete_data = loadCounts("STAR/SL1344_counts/", sample_names, sub_dir = FALSE, counts_suffix = ".counts.txt")
