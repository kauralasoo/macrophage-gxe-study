...
echo LDL.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo Creatinine.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo CRP.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo Glucose.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo HDL.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo HGB.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo HOMA_b.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo HOMA_ir.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo IL6.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo Insulin.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo MCHC.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo MCH.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo MCV.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo PCV.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo PLT.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo RBC.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
bsub -G team170 -n1 -R "span[hosts=1] select[mem>10000] rusage[mem=10000]" -q normal -M 10000 -o unify_gwas.%J.jobout "echo TC.unified | python ~/software/utils/GWAS/extractTopVariants.py --indir datasets/Inflammatory_GWAS/ --outdir datasets/Inflammatory_GWAS/"
