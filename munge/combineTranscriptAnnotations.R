...
refseq_data = tbl_df(readRDS("../../annotations/GRCh38/genes/Ensembl_85/Homo_sapiens.GRCh38.85.refseq_data.rds"))
transcript_tags = read.table("../../annotations/GRCh38/genes/Ensembl_85/Homo_sapiens.GRCh38.85.transcript_tags.txt", stringsAsFactors = FALSE)
...
saveRDS(compiled_data, "../../annotations/GRCh38/genes/Ensembl_85/Homo_sapiens.GRCh38.85.compiled_tx_metadata.rds")  
