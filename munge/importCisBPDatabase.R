...
#Collapse motifs
motifs_collapsed = dplyr::group_by(expressed_motifs, Motif_ID) %>% 
...
#Search for matches
sitesetList = searchSeq(pwmatrix_list, subject, seqname="seq1", min.score="80%", strand="*")
a = as.data.frame(sitesetList)
