...
txdb87 = makeTxDbFromBiomart(biomart = "ENSEMBL_MART_ENSEMBL", dataset = "hsapiens_gene_ensembl", 
                             host="dec2016.archive.ensembl.org")
saveDb(txdb87, "../../annotations/GRCh38/genes/Ensembl_87/TranscriptDb_GRCh38_87.db")

#Downlaod transcript metadata from Ensembl
ensembl = useMart("ENSEMBL_MART_ENSEMBL", host = "dec2016.archive.ensembl.org")
...
saveRDS(transcript_data, "../../annotations/GRCh38/genes/Ensembl_87/Homo_sapiens.GRCh38.87.transcript_data.rds")
saveRDS(refseq_data, "../../annotations/GRCh38/genes/Ensembl_87/Homo_sapiens.GRCh38.87.refseq_data.rds")
