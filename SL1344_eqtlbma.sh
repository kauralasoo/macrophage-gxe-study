...
#Merge bayes factors from perumation experiments
python ~/software/utils/eqtlbma/merge_eqtlbma_bf.py --geneBatches results/SL1344/eqtlbma/input/gene_batches.txt --outprefix eqtlbma_perm --outdir results/SL1344/eqtlbma/output_perm/ --permutationsBFs True --suffix _joinPermPvals.txt.gz
...
bsub -G team170 -n1 -R "span[hosts=1] select[mem>12000] rusage[mem=12000]" -q normal -M 12000 -o FarmOut/eqtlbma_EBF.%J.jobout "python ~/software/utils/eqtlbma/run_eqtlbma_avg_bfs.py --workdir results/SL1344/eqtlbma/output/ --outprefix eqtlbma --nsubgrp 4 --dim 15 --mode ebf"

#Calculate average BFS over configurations
bsub -G team170 -n1 -R "span[hosts=1] select[mem>12000] rusage[mem=12000]" -q normal -M 12000 -o FarmOut/eqtlbma_avg_bfs.%J.jobout "python ~/software/utils/eqtlbma/run_eqtlbma_avg_bfs.py --workdir results/SL1344/eqtlbma/output/ --outprefix eqtlbma --nsubgrp 4 --dim 15 --mode post --pi0 0.8233355"
