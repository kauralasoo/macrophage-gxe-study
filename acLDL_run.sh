...
cat macrophage-gxe-study/data/sample_lists/acLDL/acLDL_sample_gt_map.txt |  python ~/software/utils/submitJobs.py --MEM 1000 --jobname bamAddRG --command "python ~/software/utils/bam/bamAddRG.py --indir STAR/acLDL --outdir STAR/acLDL --insuffix .Aligned.sortedByCoord.out.bam --outsuffix .Aligned.sortedByCoord.RG.bam --execute True"
...
cat dtu_batches.txt | python ~/software/utils/submitJobs.py --MEM 5000 --jobname dtu_test --ncores 1 --command "/software/R-3.4.0/bin/Rscript macrophage-gxe-study/acLDL/splicing/DTU_DRIMSeq.R --phenotype revisedAnnotation"
