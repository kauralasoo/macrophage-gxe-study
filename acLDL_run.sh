...
cut -f1 macrophage-gxe-study/data/sample_lists/acLDL/acLDL_names_4.txt | python ~/software/utils/submitJobs.py --MEM 35000 --jobname star_align_041115 --ncores 8 --queue hugemem --command "python ~/software/utils/align/STAR-align.py --outputDir STAR/acLDL/ --fastqDir fastq/acLDL/ --genomeDir ../../annotations/GRCh38/STAR_index_79/ --runThreadN 8"
