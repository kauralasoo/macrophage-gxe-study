...
shared_42_pvalues = list(CD14 = importQTLtoolsTable("processed/Fairfax/qtltools/output/shared_42/CD14.permuted.txt.gz"),
                    IFN = importQTLtoolsTable("processed/Fairfax/qtltools/output/shared_42/IFN.permuted.txt.gz"),
                    LPS2 = importQTLtoolsTable("processed/Fairfax/qtltools/output/shared_42/LPS2.permuted.txt.gz"),
                    LPS24 = importQTLtoolsTable("processed/Fairfax/qtltools/output/shared_42/LPS24.permuted.txt.gz"))

#Put all results into a list
QTL_min_pvalue_list = list(full = full_pvalues, shared = shared_pvalues, shared_84 = shared_84_pvalues, shared_42 = shared_42_pvalues)
