...
bsub -G team170 -n1 -R "span[hosts=1] select[mem>1000] rusage[mem=1000]" -q normal -M 1000 -o eigenMT.%J.jobout "python ~/software/eigenMTwithTestData/eigenMT.py --CHROM 11 --QTL qtls.txt --GEN genotypes.txt --GENPOS snp_positions.txt --PHEPOS gene_positions.txt --external True --OUT exampleOut.txt"
