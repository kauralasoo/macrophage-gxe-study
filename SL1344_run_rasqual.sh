...
#Remove badly genotype feature SNPs from the VCF files
bcftools view -O z -e 'ID=@macrophage-gxe-study/data/rasqual_bad_feature_snps.txt' results/SL1344/rasqual/input/naive.ASE.vcf.gz > results/SL1344/rasqual/input/naive.ASE.filtered.vcf.gz &  
bcftools view -O z -e 'ID=@macrophage-gxe-study/data/rasqual_bad_feature_snps.txt' results/SL1344/rasqual/input/IFNg.ASE.vcf.gz > results/SL1344/rasqual/input/IFNg.ASE.filtered.vcf.gz &  
bcftools view -O z -e 'ID=@macrophage-gxe-study/data/rasqual_bad_feature_snps.txt' results/SL1344/rasqual/input/SL1344.ASE.vcf.gz > results/SL1344/rasqual/input/SL1344.ASE.filtered.vcf.gz &  
bcftools view -O z -e 'ID=@macrophage-gxe-study/data/rasqual_bad_feature_snps.txt' results/SL1344/rasqual/input/IFNg_SL1344.ASE.vcf.gz > results/SL1344/rasqual/input/IFNg_SL1344.ASE.filtered.vcf.gz &  

#Index filtered vcf files with tabix
tabix -p vcf results/SL1344/rasqual/input/naive.ASE.filtered.vcf.gz &  
tabix -p vcf results/SL1344/rasqual/input/IFNg.ASE.filtered.vcf.gz &  
tabix -p vcf results/SL1344/rasqual/input/SL1344.ASE.filtered.vcf.gz &  
tabix -p vcf results/SL1344/rasqual/input/IFNg_SL1344.ASE.filtered.vcf.gz & 
...
#Rerun batches that contain genes with bad SNPS
cat results/SL1344/rasqual/input/gene_batches_bad_snps.txt | python ~/software/utils/submitJobs.py --MEM 500 --jobname runRasqual_naive --ncores 8 --command "python ~/software/rasqual/scripts/runRasqual.py --readCounts results/SL1344/rasqual/input/naive.expression.bin --offsets results/SL1344/rasqual/input/naive.gc_library_size.bin --n 84 --geneids results/SL1344/rasqual/input/gene_names.txt --vcf results/SL1344/rasqual/input/naive.ASE.filtered.vcf.gz --geneMetadata results/SL1344/rasqual/input/gene_snp_count_500kb.txt --outprefix results/SL1344/rasqual/output/naive_500kb/batches/naive_500kb --covariates results/SL1344/rasqual/input/naive.covariates.bin --execute True --rasqualBin rasqual --parameters '\--force --n-threads 8'"
cat results/SL1344/rasqual/input/gene_batches_bad_snps.txt | python ~/software/utils/submitJobs.py --MEM 500 --jobname runRasqual_IFNg --ncores 8 --command "python ~/software/rasqual/scripts/runRasqual.py --readCounts results/SL1344/rasqual/input/IFNg.expression.bin --offsets results/SL1344/rasqual/input/IFNg.gc_library_size.bin --n 84 --geneids results/SL1344/rasqual/input/gene_names.txt --vcf results/SL1344/rasqual/input/IFNg.ASE.filtered.vcf.gz --geneMetadata results/SL1344/rasqual/input/gene_snp_count_500kb.txt --outprefix results/SL1344/rasqual/output/IFNg_500kb/batches/IFNg_500kb --covariates results/SL1344/rasqual/input/IFNg.covariates.bin --execute True --rasqualBin rasqual --parameters '\--force --n-threads 8'"
cat results/SL1344/rasqual/input/gene_batches_bad_snps.txt | python ~/software/utils/submitJobs.py --MEM 500 --jobname runRasqual_SL1344 --ncores 8 --command "python ~/software/rasqual/scripts/runRasqual.py --readCounts results/SL1344/rasqual/input/SL1344.expression.bin --offsets results/SL1344/rasqual/input/SL1344.gc_library_size.bin --n 84 --geneids results/SL1344/rasqual/input/gene_names.txt --vcf results/SL1344/rasqual/input/SL1344.ASE.filtered.vcf.gz --geneMetadata results/SL1344/rasqual/input/gene_snp_count_500kb.txt --outprefix results/SL1344/rasqual/output/SL1344_500kb/batches/SL1344_500kb --covariates results/SL1344/rasqual/input/SL1344.covariates.bin --execute True --rasqualBin rasqual --parameters '\--force --n-threads 8'"
cat results/SL1344/rasqual/input/gene_batches_bad_snps.txt | python ~/software/utils/submitJobs.py --MEM 500 --jobname runRasqual_IFNg_SL1344 --ncores 8 --command "python ~/software/rasqual/scripts/runRasqual.py --readCounts results/SL1344/rasqual/input/IFNg_SL1344.expression.bin --offsets results/SL1344/rasqual/input/IFNg_SL1344.gc_library_size.bin --n 84 --geneids results/SL1344/rasqual/input/gene_names.txt --vcf results/SL1344/rasqual/input/IFNg_SL1344.ASE.filtered.vcf.gz --geneMetadata results/SL1344/rasqual/input/gene_snp_count_500kb.txt --outprefix results/SL1344/rasqual/output/IFNg_SL1344_500kb/batches/IFNg_SL1344_500kb --covariates results/SL1344/rasqual/input/IFNg_SL1344.covariates.bin --execute True --rasqualBin rasqual --parameters '\--force --n-threads 8'"

#Figure out strange results for SPOPL
ENSG00000144228
cat results/SL1344/rasqual/input/gene_batches.txt | python ~/software/utils/submitJobs.py --MEM 500 --jobname runRasqual_IFNg --ncores 8 --command "python ~/software/rasqual/scripts/runRasqual.py --readCounts results/SL1344/rasqual/input/IFNg.expression.bin --offsets results/SL1344/rasqual/input/IFNg.gc_library_size.bin --n 84 --geneids results/SL1344/rasqual/input/gene_names.txt --vcf results/SL1344/rasqual/input/IFNg.ASE.vcf.gz --geneMetadata results/SL1344/rasqual/input/gene_snp_count_500kb.txt --outprefix results/SL1344/rasqual/output/IFNg_500kb/batches/IFNg_500kb --covariates results/SL1344/rasqual/input/IFNg.covariates.bin --execute True --rasqualBin rasqual --parameters '\--force --n-threads 8'"


cat SPOPL_batch.txt | python ~/software/utils/submitJobs.py --MEM 500 --jobname runRasqual_SPOPL --ncores 8 --command "python ~/software/rasqual/scripts/runRasqual.py --readCounts results/SL1344/rasqual/input/IFNg.expression.bin --offsets results/SL1344/rasqual/input/IFNg.gc_library_size.bin --n 84 --geneids results/SL1344/rasqual/input/gene_names.txt --vcf results/SL1344/rasqual/input/IFNg.ASE.vcf.gz --geneMetadata results/SL1344/rasqual/input/gene_snp_count_500kb.txt --outprefix IFNg_500kb_new --covariates results/SL1344/rasqual/input/IFNg.covariates.bin --execute True --rasqualBin rasqual --parameters '\--force --n-threads 8'"


cat SPOPL_batch.txt | python ~/software/utils/submitJobs.py --MEM 1000 --jobname runRasqual_SPOPL --ncores 8 --command "python ~/software/rasqual/scripts/runRasqual.py --readCounts results/SL1344/rasqual/input_old/IFNg.expression.bin  --offsets results/SL1344/rasqual/input_old/IFNg.gc_library_size.bin --n 69 --geneids results/SL1344/rasqual/input_old/feature_names.txt --vcf results/SL1344/rasqual/input_old/IFNg.ASE.vcf.gz --geneMetadata results/SL1344/rasqual/input_old/gene_snp_count_500kb.txt --outprefix IFNg_500kb_old --covariates results/SL1344/rasqual/input_old/IFNg.PEER_covariates_n3.bin --rasqualBin rasqual --parameters '\--force --n-threads 8' --execute True"
