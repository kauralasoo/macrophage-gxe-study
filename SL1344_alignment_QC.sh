...
cat macrophage-gxe-study/data/sample_lists/SL1344/SL1344_names_4.txt | python ~/software/utils/submitJobs.py --MEM 1000 --jobname merge_bams --command "python ~/software/utils/merge-fastq.py --indir fastq/SL1344/cram/ --outdir fastq/SL1344/ --suffix .1.fastq.gz"
cat macrophage-gxe-study/data/sample_lists/SL1344/SL1344_names_4.txt | python ~/software/utils/submitJobs.py --MEM 1000 --jobname merge_bams --command "python ~/software/utils/merge-fastq.py --indir fastq/SL1344/cram/ --outdir fastq/SL1344/ --suffix .2.fastq.gz"
